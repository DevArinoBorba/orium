                ...
                <button
                  ...
                  className={`px-4 sm:px-5 py-2 rounded-full text-xs sm:text-sm font-semibold transition-all duration-300 cursor-pointer ${
                    isActive
                      ...
                      : 'bg-white/[0.04] text-zinc-400 border border-white/10 hover:border-purple-500/40 hover:text-white'
                  }`}
                >
                  {cat.label}
                </button>
                ...
                >
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-purple-500/15 border border-purple-500/30 text-purple-300 group-hover:scale-110 group-hover:bg-purple-500/25 transition-transform duration-300 shadow-[0_0_20px_rgba(168,85,247,0.2)]">
                        <Icon className="h-6 w-6" />
                      </div>
                      <span className="text-[10px] uppercase tracking-widest text-purple-300/80 font-bold px-2.5 py-1 rounded-full bg-white/5 border border-white/10">
                        {service.category}
                      </span>
                    </div>
                    ...
                    {service.deliverables && (
                      <ul className="mt-6 space-y-2.5 border-t border-white/10 pt-5">
                        {service.deliverables.map((item, dIdx) => (
                          <li key={dIdx} className="flex items-start gap-2.5 text-xs text-zinc-400">
                  ...
                  <div className="mt-8 pt-5 border-t border-white/10 flex items-center justify-between">
                    <span className="text-xs font-semibold text-purple-300 group-hover:text-white flex items-center gap-1.5 transition-colors">
                      Explorar estratégia
                    ...
                    <a
                      ...
                      className="px-3 py-1.5 rounded-full text-xs font-medium text-white/80 bg-white/5 hover:bg-purple-500/20 hover:text-purple-200 border border-white/10 transition-colors"
                    >
                      Consultar
                    </a>
                  </div>
          ...
          <Reveal>
            <div className="inline-flex flex-col sm:flex-row items-center gap-4 p-4 sm:p-6 rounded-3xl glass-panel border-purple-500/30 max-w-2xl mx-auto shadow-2xl">
              <div className="text-center sm:text-left">
                <p className="text-sm font-bold text-white">Dúvida sobre qual o melhor canal para sua empresa?</p>
                <p className="text-xs text-zinc-400 mt-0.5">Fazemos uma análise gratuita do seu negócio no WhatsApp.</p>
              </div>
              <MagneticButton
                strength={0.3}
