  ...
  return (
    <aside aria-label="Atendimento rápido no WhatsApp" className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-50 flex items-center gap-3">
      ...
      <MagneticButton
        ...
        dataCursor="WhatsApp"
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-purple-600 via-fuchsia-600 to-indigo-600 text-white shadow-[0_0_30px_rgba(168,85,247,0.7)] transition-all duration-300 hover:scale-110 active:scale-95 group border border-white/20"
      >
        ...
        <svg
          viewBox="0 0 32 32"
          className="h-7 w-7 fill-current transition-transform duration-300 group-hover:scale-110 drop-shadow-md"
          aria-hidden="true"
        >
